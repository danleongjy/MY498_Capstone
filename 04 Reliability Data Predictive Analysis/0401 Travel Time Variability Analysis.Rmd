...
```{r}
dv <- 'traveltime_95pc_minus_5pc'
ivs <- c('1','dist_bus','dist_coach','dist_dlr','dist_nationalrail','dist_overground','dist_riverbus','dist_tflrail','dist_tram','dist_tube','dist_walking')
lm_formula <- as.formula(paste(dv, '~', paste(ivs, collapse = ' + ')))
```
...
```{r}
dv <- 'traveltime_95pc_minus_5pc'
ivs <- c('1','dv_local_mean','dist_bus','dist_coach','dist_dlr','dist_nationalrail','dist_overground','dist_riverbus','dist_tflrail','dist_tram','dist_tube','dist_walking')
lm_formula <- as.formula(paste(dv, '~', paste(ivs, collapse = ' + ')))
```
...
tm_shape(results_lwr02_pvals_spatial) + 
  tm_fill(c(colnames(results_lwr02_pvals_spatial@data)), palette = 'Blues') +
tm_shape(londontube) + 
  tm_lines(lwd = .1, col = 'black') +
tm_shape(londonrail) + 
  tm_lines(lwd = .1, col = 'black') + 
