...
```{r}
regressiontable <- matrix(nrow = length(ivs), ncol = 11, dimnames = list(c(ivs),c('OLS','OLS 95CI_L','OLS 95CI_U','OLS with Spillovers','OLS with Spillovers 95CI_L','OLS with Spillovers 95CI_U','LWR Min','LWR 25%','LWR 50%','LWR 75%','LWR Max')))
...
for (row in rownames(regressiontable)) {
  if (row %in% names(lm_global$coefficients)) {
    regressiontable[row,'OLS'] <- round(lm_global$coefficients[row],3)
    regressiontable[row,'OLS 95CI_L'] <- round(confint(lm_global)[row,1],3)
    regressiontable[row,'OLS 95CI_U'] <- round(confint(lm_global)[row,2],3)
  }
...
# 
# regressiontable['1','OLS'] <- round(lm_global$coefficients[1],3)
# regressiontable['1','OLS 95CI_L'] <- round(confint(lm_global)[1,1])
# regressiontable['1','OLS 95CI_U'] <- round(confint(lm_global)[1,2])
# regressiontable['1','OLS with Spillovers'] <- round(lm_global_local_spillovers$coefficients[1],3)
# regressiontable['1','OLS with Spillovers 95CI_L'] <- round(confint(lm_global_local_spillovers)[1,1])
# regressiontable['1','OLS with Spillovers 95CI_U'] <- round(confint(lm_global_local_spillovers)[1,2])
